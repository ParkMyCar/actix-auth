#![allow(dead_code)] // useful in dev mode
#[macro_use]
extern crate diesel;
#[macro_use]
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .wrap(IdentityService::new(
                CookieIdentityPolicy::new("this is a secret that is atleast 32 bytes".as_bytes())
                    .name("auth")
                    .path("/")
            ...
            .service(
                ...
                .service(web::resource("/register/{invitation_id}").route(web::post().to(|| {})),
                )
